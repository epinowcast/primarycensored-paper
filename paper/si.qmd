...
By substituting the gamma partial expectation equation into the survival function equation we can solve for the survival function of $S_+$ in terms of analytically available functions:
...
[This section will contain detailed accuracy metrics across all distributions and sample sizes, along with additional visualizations.]

## Extended parameter recovery results

[This section will contain full results across all sample sizes, detailed convergence diagnostics, and additional parameter visualizations for both Stan-based and fitdistrplus-based estimation, along with a comprehensive comparison with naive models.]

## Extended case study results

[This section will contain complete parameter visualizations and additional comparative outputs for the Ebola case study, including detailed computational performance metrics.]