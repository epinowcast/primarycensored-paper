...
$$P(T_c = t_S - t_P \mid \text{observed}) = \frac{F_{\text{cens}}(t_S + w_S - t_P) - F_{\text{cens}}(t_S - t_P)}{F_{\text{cens}}(D - t_P)}.$$

which is equivalent to,

$$P(T_c = t_S - t_P \mid \text{observed}) = \frac{P(S \in [t_S, t_S + w_S] \mid P_u \in [t_P, t_P + w_P])}{P(S < D \mid P_u \in [t_P, t_P + w_P])}$$
