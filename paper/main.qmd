...
#### Problem statement
- Double interval censoring and truncation definitions
- Notation and variable definitions
- Assumptions about non-informative censoring

#### Generative model
- Random sampling process (similar to primarycensored.Rmd)
- Steps from primary event to observed delays

### Solving the censoring problem

#### Primary event censored distributions
- Mathematical formulation of the CDF problem
- Derivation of the survival function approach
- Connection between approaches

#### Secondary event censoring extension
- From CDF to PMF with secondary censoring
- Effects of discrete observation windows

#### Truncation adjustment
- Adjusting for right truncation in outbreak settings
- Normalized likelihood for truncated distributions
...
- Special case of uniform primary intervals
