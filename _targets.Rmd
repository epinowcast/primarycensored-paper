...
growth_rate <- params$growth_rate  # Exponential growth rate as per manuscript
simulation_n <- params$simulation_n  # Number of observations per scenario
base_seed <- params$base_seed  # Base seed for reproducibility
...
```{targets scenario_list, tar_simple = TRUE}
